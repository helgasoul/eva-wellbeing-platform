...
const defaultData: AboutPlatformData = {
  ...
  principles: {
    scientific: {
      ...
      description: "Все решения основаны на доказательной медицине и последних научных исследованиях"
    },
    personalization: {
      title: "Персонализация",
      description: "Каждая рекомендация адаптируется под индивидуальные особенности пользователя"
    },
    empathy: {
      title: "Эмпатия",
      description: "Мы понимаем уникальные потребности женщин на разных этапах жизни"
    },
    security: {
      title: "Безопасность",
      description: "Высочайшие стандарты защиты персональных данных и медицинской информации"
    }
  },
  experts: [
    {
