...
import veraPhoto from '@/assets/vera-didenko-real-photo.jpg';
...
const defaultData: AboutPlatformData = {
  ...
  cofounder: {
    name: "Вера Владимировна Диденко",
    bio: "Со-основательница и главный медицинский консультант",
    story: "К проекту без | паузы присоединилась благодаря своему многолетнему опыту работы в области онкологии и женского здоровья. Как заведующая отделением диагностики и лечения заболеваний молочной железы и репродуктивной системы, она понимает важность своевременной диагностики и персонализированного подхода к каждой пациентке.",
    experience: "Врач-онколог высшей категории, мультимодальный диагност, обладатель статуса 'Московский врач'",
    vision: "Стремлюсь сделать высокопрофессиональную медицинскую помощь доступной каждой женщине через современные технологии и человеческий подход",
    photo: veraPhoto
  },
  principles: {
    scientific: {
  ...
  experts: [
    ...
    {
      id: "2", 
      name: "Др. Марина Климкова",
      specialization: "Врач превентивной медицины",
      achievements: "Эксперт в области профилактики заболеваний и здорового образа жизни. Кандидат медицинских наук, автор программ по превентивной медицине",
      interests: "Специализируется на раннем выявлении заболеваний, разработке индивидуальных программ профилактики и укреплении здоровья женщин",
      role: "Консультант по превентивной медицине", 
      photo: "/lovable-uploads/5a5a63b3-0afb-4615-94ac-ef8e1aa133b8.png",
      quote: "Профилактика - лучшее лечение. Моя цель помочь каждой женщине сохранить здоровье на долгие годы",
      approach: "Применяю комплексный подход к профилактике, сочетая современные методы диагностики с персонализированными рекомендациями"
    }
  ],
  technologies: {
