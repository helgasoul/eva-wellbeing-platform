      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="text-lg md:text-xl mb-8 text-muted-foreground max-w-4xl mx-auto leading-relaxed animate-fade-in space-y-4" style={{ animationDelay: '0.2s' }}>
            <p>
              Bloom — это забота и поддержка для женщин в период перемен.
            </p>
            <p>
            ...
            <p>
              После 35 лет многие женщины переживают переосмысление, сталкиваются с новыми вопросами о себе и будущем. Bloom помогает пройти через эти перемены с пониманием и поддержкой, сохраняя психологическое здоровье, уверенность и полноценную жизнь, несмотря на изменения в теле и гормональном фоне.
            </p>
