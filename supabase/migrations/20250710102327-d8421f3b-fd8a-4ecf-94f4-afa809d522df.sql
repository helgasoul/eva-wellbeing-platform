...
-- Сначала удаляем связанные данные из публичных таблиц
...
BEGIN
    ...
    -- Удаляем связанные данные из публичных таблиц для первого пользователя
    IF user_id_1 IS NOT NULL THEN
        ...
        DELETE FROM public.cycle_entries WHERE user_id = user_id_1;
        ...
        DELETE FROM public.user_levels WHERE user_id = user_id_1;
    ...
    -- Удаляем связанные данные из публичных таблиц для второго пользователя
    IF user_id_2 IS NOT NULL THEN
        ...
        DELETE FROM public.cycle_entries WHERE user_id = user_id_2;
        ...
        DELETE FROM public.user_levels WHERE user_id = user_id_2;
